...
--2. ?사원의 이름, 급여, 연간 총수입(total_salary)을 급여가 많은 것 부터 작은 순으로 출력하세요. 연간 총수입은 월급에 *12를 한 후 $100의 상여금을 더해서 계산하세요.
...
--6. 1981년 2월 20일(81/02/20) 부터 1981년 5월 1일(81/05/01) 사이에 입사한 사원의 이름, 담당업무, 입사일을 출력하세요.
